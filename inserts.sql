...
('Juan', 'Carlos', 'Martínez', 'Gómez', 100001, 1, NULL),
('María', 'Fernanda', 'López', 'Rodríguez', 100002, 2, NULL),
('Carlos', NULL, 'Pérez', 'Hernández', 100003, 3, NULL),
('Luisa', 'Andrea', 'González', 'Morales', 100004, 4, NULL),
('Andrés', 'Felipe', 'Ramírez', 'Torres', 100005, 5, NULL),
('Camila', 'Sofía', 'Díaz', 'Jiménez', 100006, 6, NULL),
('Jorge', 'Alberto', 'Ortiz', 'Cruz', 100007, 7, NULL),
('Paula', 'Ximena', 'Rojas', 'Vargas', 100008, 8, NULL),
('Felipe', 'Andrés', 'Castro', 'Muñoz', 100009, 9, NULL),
('Diana', 'Carolina', 'Moreno', 'Ríos', 100010, 1, NULL),
('Oscar', 'Iván', 'Cortés', 'Navarro', 100011, 2, NULL),
('Santiago', NULL, 'Sánchez', 'Quintero', 100012, 3, NULL),
('Natalia', 'Marcela', 'Guzmán', 'Mejía', 100013, 4, NULL),
('Fernando', NULL, 'Navarro', 'García', 100014, 5, NULL),
('Alejandra', 'Tatiana', 'Herrera', 'Chacón', 100015, 6, NULL),
('Laura', NULL, 'Mendoza', 'Valencia', 100016, 7, NULL),
('Luis', 'Enrique', 'Bermúdez', 'Ospina', 100017, 8, NULL),
('Gloria', 'Patricia', 'Salazar', 'Zapata', 100018, 9, NULL),
('Pablo', 'Emilio', 'Vargas', 'Castaño', 100019, 1, NULL),
('Sofía', 'Valentina', 'Ruiz', 'Cardona', 100020, 2, NULL);
INSERT INTO empleado (nombre1, nombre2, apellido1, apellido2, cedula, id_cargo, id_login) VALUES
('Andrea', 'Patricia', 'Velásquez', 'Gómez', 100021, 3, NULL),
('David', 'Esteban', 'Lara', 'Montoya', 100022, 4, NULL),
('Sebastián', 'Julián', 'Arango', 'Giraldo', 100023, 1, NULL),
('Carolina', 'Marcela', 'Osorio', 'Mejía', 100024, 2, NULL),
('Gabriel', NULL, 'Álvarez', 'Restrepo', 100025, 5, NULL),
('Mónica', 'Susana', 'Valencia', 'Rendón', 100026, 6, NULL),
('Julián', 'Mateo', 'Pineda', 'Toro', 100027, 7, NULL),
('Laura', NULL, 'Cardona', 'Serna', 100028, 8, NULL),
('Ángela', 'Luz', 'Rendón', 'Marín', 100029, 9, NULL),
('Rodrigo', 'Enrique', 'Molina', 'Henao', 100030, 3, NULL),
('Isabela', 'Sofía', 'Castaño', 'Hoyos', 100031, 4, NULL),
('Ricardo', 'Fernando', 'Morales', 'Quintero', 100032, 1, NULL),
('Cecilia', NULL, 'García', 'Villa', 100033, 2, NULL),
('Mauricio', 'Antonio', 'Ángel', 'Duque', 100034, 5, NULL),
('Juliana', 'Cristina', 'Cano', 'Ramírez', 100035, 6, NULL),
('Fabio', 'Humberto', 'Trujillo', 'Ortega', 100036, 7, NULL),
('Camilo', NULL, 'Montes', 'Vargas', 100037, 8, NULL),
('Sandra', 'Milena', 'Zapata', 'Castañeda', 100038, 9, NULL),
('Manuel', 'José', 'Pérez', 'Cardona', 100039, 3, NULL),
('Beatriz', 'Lina', 'Ramírez', 'Gómez', 100040, 4, NULL),
('Leonardo', NULL, 'Giraldo', 'Arbeláez', 100041, 1, NULL),
('Diana', 'Esther', 'Hernández', 'Salazar', 100042, 2, NULL),
('Alexander', 'Edwin', 'Toro', 'Villegas', 100043, 5, NULL),
('Lorena', 'Viviana', 'Quintero', 'Muñoz', 100044, 6, NULL),
('Rafael', 'Alfonso', 'Tamayo', 'Zapata', 100045, 7, NULL),
('Esteban', NULL, 'Buitrago', 'Córdoba', 100046, 8, NULL),
('Natalia', 'Mariana', 'Mendoza', 'Agudelo', 100047, 9, NULL),
('Felipe', 'Iván', 'Jaramillo', 'López', 100048, 3, NULL),
('Liliana', 'Maribel', 'Restrepo', 'Sierra', 100049, 4, NULL),
('Tomás', 'Guillermo', 'Moreno', 'Gómez', 100050, 1, NULL);
...
('Juan', 'Carlos', 'Pérez', 'Gómez', 1001001001, NULL),
('María', 'Fernanda', 'Rodríguez', 'López', 1002002002, NULL),
('Luis', 'Alberto', 'Martínez', 'Sánchez', 1003003003, NULL),
('Ana', 'Lucía', 'Hernández', 'Ramírez', 1004004004, NULL),
('Pedro', 'Javier', 'García', 'Morales', 1005005005, NULL),
('Laura', 'Sofía', 'Torres', 'Ortiz', 1006006006, NULL),
('Carlos', 'Andrés', 'Vargas', 'Mendoza', 1007007007, NULL),
('Lucía', 'Gabriela', 'Ríos', 'Castro', 1008008008, NULL),
('Fernando', 'José', 'Díaz', 'Guerrero', 1009009009, NULL),
('Paula', 'Andrea', 'Jiménez', 'Navarro', 1010010010, NULL),
('Jorge', 'Armando', 'Mendoza', 'Vega', 1011011011, NULL),
('Carolina', 'Mariana', 'Ortiz', 'Campos', 1012012012, NULL),
('Ricardo', 'Daniel', 'Guzmán', 'Flores', 1013013013, NULL),
('Andrea', 'Paola', 'Romero', 'Silva', 1014014014, NULL),
('Diego', 'Alejandro', 'Navarro', 'Espinoza', 1015015015, NULL),
('Valentina', 'Isabel', 'Rojas', 'Barrera', 1016016016, NULL),
('Santiago', 'Esteban', 'Moreno', 'Quintero', 1017017017, NULL),
('Diana', 'Marcela', 'Cortés', 'Villalobos', 1018018018, NULL),
('Miguel', 'Ángel', 'Reyes', 'Palacios', 1019019019, NULL),
('Sofía', 'Alejandra', 'Luna', 'Rincón', 1020010020, NULL),
('Camilo', 'Adrián', 'Barrios', 'Valencia', 1021011021, NULL),
('Natalia', 'María', 'Zapata', 'Nieves', 1022012022, NULL),
('Samuel', 'Iván', 'Pacheco', 'Bautista', 1023013023, NULL),
('Juliana', 'Lorena', 'Peña', 'Chávez', 1024014024, NULL),
('Manuel', 'Felipe', 'Ruiz', 'Mejía', 1025015025, NULL),
('Sara', 'Elena', 'Álvarez', 'Villanueva', 1026016026, NULL),
('Esteban', 'Mauricio', 'Vega', 'González', 1027017027, NULL),
('Eliana', 'Carolina', 'López', 'Campos', 1028018028, NULL),
('Ángel', 'Ricardo', 'Santos', 'Vallejo', 1029019029, NULL),
('Isabella', 'Luciana', 'Castaño', 'Pineda', 1030010030, NULL),
('Tomás', 'Sebastián', 'Márquez', 'Cáceres', 1031011031, NULL),
('Gabriela', 'Luisa', 'Herrera', 'Hernández', 1032012032, NULL),
('Cristian', 'David', 'Galeano', 'Ortiz', 1033013033, NULL),
('Daniela', 'Florencia', 'Carrillo', 'Pérez', 1034014034, NULL),
('Andrés', 'Camilo', 'Espinosa', 'Castellanos', 1035015035, NULL),
('Mariana', 'Beatriz', 'Salazar', 'Martínez', 1036016036, NULL),
('Emilio', 'Álvaro', 'Cabrera', 'Suárez', 1037017037, NULL),
('Luisa', 'Cristina', 'Bermúdez', 'Patiño', 1038018038, NULL),
('Iván', 'Eduardo', 'Trujillo', 'Montoya', 1039019039, NULL),
('Verónica', 'Mónica', 'Chaparro', 'Zambrano', 1040010040, NULL),
('Pablo', 'César', 'Osorio', 'Cárdenas', 1041011041, NULL),
('Carmen', 'María', 'Roldán', 'Prado', 1042012042, NULL),
('Felipe', 'Antonio', 'Muñoz', 'Guerrero', 1043013043, NULL),
('Marcela', 'Patricia', 'Delgado', 'Naranjo', 1044014044, NULL),
('Oscar', 'Rubén', 'Vallejo', 'Sandoval', 1045015045, NULL),
('Silvia', 'Victoria', 'Molina', 'Arce', 1046016046, NULL),
('Javier', 'Enrique', 'Lemos', 'Moreno', 1047017047, NULL),
('Cristina', 'Liliana', 'Castillo', 'Camacho', 1048018048, NULL),
('Rafael', 'Julián', 'Serrano', 'Beltrán', 1049019049, NULL),
('Rosa', 'Mercedes', 'Nieto', 'Padilla', 1050010050, NULL);
